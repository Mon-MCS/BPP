...
mediante excepciones lo siguiente:
a. Sólo se podrá introducir números enteros.
b. Si el número es mayor de 10 se lanza una excepción con raise la cual hayas 
...
""" 
2. Abre un fichero .txt y controla mediante excepciones las diferentes casuisticas para
